...
def get_parser(parser=None):
    ...
    model_arg.add_argument(
        "--d_z", type=int, default=512, help="Latent vector dimensionality"
    )
    model_arg.add_argument(
    ...
    train_arg.add_argument(
        "--tb_log_interval", type=int, default=133, help="Batch size"
    )
    ...
    train_arg.add_argument(
        "--kl_w_start", type=float, default=0.01, help="Initial kl weight value"
    )
    train_arg.add_argument(
        "--kl_w_end", type=float, default=0.05, help="Maximum kl weight value"
    )
    train_arg.add_argument(
        "--lr_start", type=float, default=1e-4, help="Initial lr value"
    )
    train_arg.add_argument(
        "--lr_n_period",
        type=int,
